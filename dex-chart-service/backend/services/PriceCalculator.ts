// backend/services/PriceCalculator.ts
// FIXED: Made constants public static so they can be accessed from indexer
...
export class PriceCalculator {
  // ✅ FIXED: Changed from private to public static
  ...
  private static isStablecoin(tokenAddress: string): boolean {
    ...
    return this.STABLE_COINS.some(coin => lowerAddr.includes(coin));
  }

  /**
   * Get pair address (for caching purposes)
   */
