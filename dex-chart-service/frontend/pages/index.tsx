            ...
            <div className="flex items-center justify-between">
              ...
              <div className="relative w-[450px]">
                ...
                {searchResults && searchResults.length > 0 && (
                  <div className="absolute top-full left-0 right-0 mt-1 bg-[#1a1a1a] border border-gray-700 rounded-lg shadow-lg max-h-96 overflow-y-auto z-50">
            ...
            <div className="flex-1 overflow-y-auto">
              {loadingPairs ? (
                ...
                getTrendingList().map((item: any) => {
                  ...
                  const change = isToken ? (item.priceChange24h || 0) : (item.token0?.priceChange24h || 0)
                    ...
                    >
                      ...
                      <div className="flex justify-between items-center mb-1">
                        <span className="text-lg font-semibold">
                          {PriceCalculator.formatPrice(price || 0, priceDisplay)}
                        </span>
